...
cmd({
    ...
    try {
        ...
        const response = await axios.get(`https://antagoniste-md-session.onrender.com/code?number=${encodeURIComponent(phoneNumber)}`);
        ...
        const doneMessage = "> *ANTAGONISTE-MD PAIRING COMPLETED*";
...
cmd({
    ...
    try {
        ...
        const sentMessage = await conn.sendMessage(from, {
            ...
            caption: `- *Pairing Code For ANTAGONISTE-MD ⚡*\n\n Notification has been sent to your WhatsApp. Please check your phone and copy this code to pair it and get your *ANTAGONISTE-MD* session id.\n\n*🔢 Pairing Code*: *${pairingCode}*\n\n> *Copy it from below message 👇🏻*`
        }, { quoted: m });
