...
async (conn, mek, m, { from, reply }) => {
    const githubRepoURL = 'https://github.com/Antagonist-tech/ANTAGONISTE-MD';
    ...
    try {
        ...
        const formattedInfo = `
╭─〔 *ANTAGONISTE-MD REPOSITORY* 〕
│
├─ *📌 Repository Name:* ${repoData.name}
├─ *👑 Owner:*𝘈𝘕𝘛𝘈𝘎𝘖𝘕𝘐𝘚𝘛𝘌-ʈ𝛆̽ɕ̄ⴙ
├─ *⭐ Stars:* ${repoData.stargazers_count}
├─ *⑂ Forks:* ${repoData.forks_count}
├─ *📝 Description:* ${repoData.description || 'World Best WhatsApp Bot powered by 𝘈𝘕𝘛𝘈𝘎𝘖𝘕𝘐𝘚𝘛𝘌-TECHX'}
│
├─ *🔗 GitHub Link:*
│   ${repoData.html_url}
│
...
`.trim();
        ...
        await conn.sendMessage(from, {
            image: { url: `https://files.catbox.moe/yfajre.png` }, // Replace with your image URL
