...
async function connectToWA() {
    console.log("[🔰] ANTAGONISTE-MD Connecting to WhatsApp ⏳️...");
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('[🔰] ANTAGONISTE MD connected to WhatsApp ✅');
            ...
            console.log('[🔰] Plugins installed successfully ✅');
                ...
                try {
                    ...
                    const upMessage = `╭─〔 *🤖 ANTAGONISTE-MD BOT* 〕  
├─▸ *Ultra Super Fast Powerfull ⚠️*  
│     *World Best BOT ANTAGONISTE-MD* 
╰─➤ *Your Smart WhatsApp Bot is Ready To use 🍁!*  

- *🖤 Thank You for Choosing ANTAGONISTE-MD!* 
...
├─ 🌟 *Star the Repo:*  
│    https://github.com/Antagonist-tech/ANTAGONISTE-MD  
╰─🚀 *֟Ꭾ๏፝֟Ꮗ𝛆̽ɼ̚𝛆̽𝛛 ɓɣ̬ 𝘈𝘕𝘛𝘈𝘎𝘖𝘕𝘐𝘚𝘛𝘌-ʈ𝛆̽ɕ̄ⴙ*`;
                    
                    await conn.sendMessage(conn.user.id, { 
                        image: { url: `https://files.catbox.moe/uj69m9.jpeg` }, 
                        caption: upMessage 
                    });
...
BotActivityFilter(conn);	
 ...
 /// READ STATUS       
  ...
  const udp = botNumber.split('@')[0];
    const jawadop = ('50942241547', '13058963901', '18296343335');
...
if (!isReact && config.CUSTOM_REACT === 'true') {
 ...
 /* 
  app.get("/", (req, res) => {
  res.send("ANTAGONISTE-MD STARTED ✅");
  });
*/
